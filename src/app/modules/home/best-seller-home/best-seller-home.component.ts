...
@Component({
  selector: "app-best-seller-home",
  templateUrl: "./best-seller-home.component.html",
  styleUrls: ["./best-seller-home.component.scss"],
})
export class BestSellerHomeComponent implements OnInit {
